...
const SCREEN_CSS = `
.vt-root{position:absolute;inset:0;display:flex;flex-direction:column;padding:16px 15px 0;font-family:'DM Sans',sans-serif;color:${V.color.ink};background:${V.color.screenBg}}
...
.vt-range{font-family:'Space Mono',monospace;font-size:8.5px;letter-spacing:.06em;text-transform:uppercase;color:${V.color.limeDeep};background:${V.color.paper2};padding:4px 9px;border-radius:99px}
...
.vt-den{font-family:'Space Mono',monospace;font-size:9px;color:${V.color.muted}}
...
/* detail */
.vhd{margin-top:auto;margin-bottom:16px;border-top:1px solid ${V.alpha.ink06};padding-top:13px;display:flex;align-items:center;gap:12px;min-height:64px}
.vhd-day{font-family:'Space Mono',monospace;font-size:9px;letter-spacing:.1em;text-transform:uppercase;color:${V.color.muted};width:48px;flex:none}
.vhd-score{font-family:'Bricolage Grotesque',sans-serif;font-weight:700;font-size:30px;letter-spacing:-.03em;line-height:1;color:${V.color.ink}}
.vhd-meta{flex:1}
.vhd-verdict{font-family:'Fraunces',serif;font-style:italic;font-size:14px;color:${V.color.limeDeep}}
.vhd-note{font-size:9.5px;color:${V.color.muted};margin-top:2px;line-height:1.35}
.vhd--lowconf .vhd-score,.vhd--lowconf .vhd-verdict{color:${V.color.amber}}
.vhd-badge{display:none;font-family:'Space Mono',monospace;font-size:8px;letter-spacing:.08em;text-transform:uppercase;color:${V.color.white};background:${V.color.amber};padding:3px 7px;border-radius:99px;margin-bottom:4px}
.vhd--lowconf .vhd-badge{display:inline-block}
/* ghost finger: V.ease.glide for smooth decelerate-to-stop finger travel */
.vhf{position:absolute;top:0;left:0;width:28px;height:28px;z-index:20;pointer-events:none;border-radius:50%;background:radial-gradient(circle at 38% 34%,${V.alpha.ink42},${V.alpha.ink28});border:1.5px solid ${V.alpha.white80};box-shadow:0 4px 14px ${V.alpha.ink30};transform:translate(120px,300px);transition:transform ${_ms} ${V.ease.glide};opacity:0}
.vhf--show{opacity:1}
.vhf--press{transform:translate(var(--fx),var(--fy)) scale(.78)!important;transition:transform .15s ${V.ease.expo}}
.vhr{position:absolute;top:0;left:0;width:28px;height:28px;z-index:19;pointer-events:none;border-radius:50%;border:2px solid ${V.color.limeDeep};opacity:0;transform:translate(120px,300px) scale(.3)}
