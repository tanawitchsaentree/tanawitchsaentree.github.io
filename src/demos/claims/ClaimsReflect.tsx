        ...
        <div className="claims-wrap">
          <div className="claims-animate">
            ...
            <blockquote style={{
              ...
              then decide what medium makes it testable.
            </blockquote>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.1rem', marginTop: '2.2rem', maxWidth: '62ch' }}>
              {[
                ...
                { q: 'Nobody asked me to work this way.', a: 'I decided the deliverable needed to change. The loop, the skill library, and the verify-separate-from-build constraint were all personal initiative. That\'s not a credential. It\'s a choice I\'ll keep making.' },
              ].map(({ q, a }) => (
                <div key={q} style={{ borderLeft: `2px solid ${C.color.lineBri}`, paddingLeft: '1rem' }}>
                  ...
                  <p style={{ fontSize: '1rem', color: C.color.tx, lineHeight: 1.6, margin: 0 }}>{a}</p>
                </div>
              ))}
            </div>
