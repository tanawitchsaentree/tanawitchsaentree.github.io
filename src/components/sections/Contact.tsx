    ...
    <section id="contact" aria-labelledby="contact-heading" className="w-full text-center">
      ...
      <div className="flex flex-col items-center gap-10">
        ...
        <div className="flex flex-col items-center gap-1">
          <p className="text-[var(--type-xs)] text-[var(--fg-subtle)]" style={{ fontFamily: "'IBM Plex Mono', monospace", letterSpacing: '0.08em' }}>
            Set in IBM Plex Mono · Built with Next.js · GitHub Pages
          </p>
          <p className="text-[var(--type-xs)] text-[var(--fg-subtle)]" style={{ fontFamily: "'IBM Plex Mono', monospace", letterSpacing: '0.08em' }}>
